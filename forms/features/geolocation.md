...
![Geolocation screen](/img/pentagram.svg)
...
![Geolocation block settings screen](/img/pentagram.svg)

### Show only option

This feature will limit this form only to be shown to the users from the selected country.

![Geolocation only use screen](/img/pentagram.svg)
...
![Geolocation modal screen](/img/pentagram.svg)
